...
const PREDICTION_MODELS: PredictionModel[] = [
  ...
  { id: 'historical', name: 'Historical Average', description: 'Based on historical performance trends' },
  { id: 'weighted', name: 'Weighted Model', description: 'Combines multiple factors' },
  { id: 'ml', name: 'Machine Learning', description: 'Advanced ML predictions' },
];
